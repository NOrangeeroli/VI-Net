...
if __name__ == "__main__":
    ...
    checkpoint = os.path.join(cfg.log_dir, 'VI_Net_geo', 'epoch_' + str(cfg.test_epoch) + '.pth')
    ...
    save_path = cfg.save_path + '/VI_Net_geo/epoch_' + str(cfg.test_epoch) 
